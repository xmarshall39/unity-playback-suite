...
namespace UPBS.UI
{
    ...
    public class FillableDirectoryField : MonoBehaviour
    {
        ...
        private void SetDirectory(string directory)
        {
            ...
            if (UPBS.Player.PBLoadingManager.Instance != null && UPBS.Player.PBLoadingManager.Instance.ValidateDirectory(_directoryText.text, out string baseSceneName))
            {
        ...
        {
            UPBS.Player.PBLoadingManager.Instance?.Load(_directoryText.text, validPlaybackScenesDropdown.options[validPlaybackScenesDropdown.value].text);
        }
