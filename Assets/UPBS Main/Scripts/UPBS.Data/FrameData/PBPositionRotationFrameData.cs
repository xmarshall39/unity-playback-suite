...
namespace UPBS.Data
{
    public class PBPositionRotationFrameData : PBFrameDataBase
    {
        public Vector3 WorldPosition { get; protected set; } = Vector3.zero;
        public Vector3 EulerRotation { get; protected set; } = Vector3.zero;

        public PBPositionRotationFrameData() : base()
        {

        }

        public PBPositionRotationFrameData(PBPositionRotationFrameData other) : base(other)
        {
