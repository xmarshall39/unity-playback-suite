...
namespace UPBS
{
    public class UPBSEditorStyles : MonoBehaviour
    {
        ...
        public static GUIStyle UtilityButton_2
        {
            get
            {
                if (utilityButton == null)
                {
                    ...
                    utilityButton.fontStyle = Header2.fontStyle;
                    utilityButton.fontSize = Header2.fontSize;
                    utilityButton.padding = Header2.padding;
                }
